...
const Product3 = () => {
  ...
  return (
    <div className="product3-page" id="product3">
      <div className="product3-details">
        <div className="left3-side">
          <img loading="lazy"
            ref={imageRef}
            src={image}
            alt="Product"
        ...
        <div className="right3-side">
          <div ref={descriptionRef} className="description3">
          ...
          <div ref={detailsRef} className="product3-details-list">
            ...
            <ul>
              ...
              <li>
                <strong>Battery features:</strong> LFP with 1500 cycles , active balancing , waterproof(IP67)
              </li>
              <li>
